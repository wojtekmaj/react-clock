...
describe('Mark', () => {
  it('renders a hand with given name', async () => {
    const { container } = await render(<Mark name="minute" />);
  ...
  it('renders mark angled at 0° by default', async () => {
    const { container } = await render(<Mark name="minute" />);
  ...
  it('renders properly angled mark given angle prop', async () => {
    const { container } = await render(<Mark angle={15} name="minute" />);
  ...
  it('renders mark with 10% length by default', async () => {
    const { container } = await render(<Mark name="minute" />);
  ...
  it('renders mark with proper length given length prop', async () => {
    const { container } = await render(<Mark length={50} name="minute" />);
  ...
  it('renders mark with 1px width by default', async () => {
    const { container } = await render(<Mark name="minute" />);
  ...
  it('renders mark with proper length given length prop', async () => {
    const { container } = await render(<Mark name="minute" width={5} />);
